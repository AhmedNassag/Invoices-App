        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('قائمة الفواتير')
                    <li>
                        <a class="slide-item" href="{{ url('/' . $page='invoice') }}">قائمة الفواتير</a>
                    </li>
                    @endcan
                    ...
                    <li>
                        <a class="slide-item" href="{{ url('/' . ($page = 'Invoice_UnPaid')) }}">الفواتير الغير مدفوعة</a>
                    </li>
                    @endcan

                    @can('الفواتير المدفوعة جزئيا')
                    <li>
                        <a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Partial')) }}">الفواتير المدفوعة جزئياً</a>
                    </li>
                    @endcan

                    @can('أرشيف الفواتير')
                    <li>
                        {{-- <a class="slide-item" href="{{ url('/' . ($page = 'Archive')) }}">أرشيف الفواتير</a> --}}
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('الأقسام')
                    <li>
                        <a class="slide-item" href="{{ url('/' . $page='section') }}">الأقسام</a>
                    </li>
                    @endcan

                    @can('المنتجات')
                    <li>
                        <a class="slide-item" href="{{ url('/' . $page='product') }}">المنتجات</a>
                    </li>
                    @endcan
                </ul>
            </li>
