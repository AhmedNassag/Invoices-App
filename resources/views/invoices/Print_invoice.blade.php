                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6>Innovation Software Company</h6>
                                <p>24 Amer St., Dokki, Giza, Egypt<br>
                                    Tel No: 01141090116<br>
                                    Email: innovation@company.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6>Ahmed Nabil Esmail</h6>
                                    <p>Helwan, Cairo, Egypt<br>
                                        Tel No: 01016856433<br>
                                        Email: ahmednassag@gmail.com</p>
                                </div>
                            </div>
                            <div class="col-md">
